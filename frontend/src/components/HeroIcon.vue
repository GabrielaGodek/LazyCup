<template>
    <div class="h-full w-full object-cover object-center">
        <router-link aria-label="Click here to order" :to="{ name: 'products' }">
            <svg width="100%" height="100%" viewBox="0 0 1024.00 1024.00" class="icon" version="1.1"
                ...
                <g id="SVGRepo_iconCarrier">
                    ...
                    <path
                        ...
                        fill="#F4F4F4" class="svg-elem-2"></path>
                    <path
                    ...
                    <path
                        ...
                        fill="#C1B59F" class="svg-elem-4"></path>
                    <path
                        ...
                        fill="#4D493E" class="svg-elem-5"></path>
                    <path
